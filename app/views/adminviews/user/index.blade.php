...
<div class="card shadow-sm">
    <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
        ...
        <a href="/admin/user/create" class="btn btn-light btn-sm fw-bold">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <form action="/admin/user/delete/{{ $u['id'] }}" method="POST" class="d-inline" onsubmit="return confirmDelete();">
