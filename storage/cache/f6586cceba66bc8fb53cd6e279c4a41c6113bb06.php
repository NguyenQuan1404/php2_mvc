<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark admin-sidebar-inner" style="width: 260px; height: 100vh;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item mb-2">
            <a href="/dashboard" class="nav-link text-white <?php echo e((strpos($currentUri, '/dashboard') !== false || $currentUri == '/admin') ? 'active' : ''); ?>">
        ...
        <li class="nav-item mb-1">
            <a href="/category" class="nav-link text-white <?php echo e(strpos($currentUri, '/category') !== false ? 'active' : ''); ?>">
                <i class="fa-solid fa-layer-group me-3 icon-width"></i>
                Danh mục (Đế giày)
            </a>
        </li>
        <li class="nav-item mb-1">
            <a href="/brand" class="nav-link text-white <?php echo e(strpos($currentUri, '/brand') !== false ? 'active' : ''); ?>">
                <i class="fa-solid fa-copyright me-3 icon-width"></i>
                Thương hiệu
            </a>
        </li>
        <li class="nav-item mb-1">
            <a href="/product" class="nav-link text-white <?php echo e(strpos($currentUri, '/product') !== false ? 'active' : ''); ?>">
        ...
        <li class="nav-item mb-1">
            <a href="/user" class="nav-link text-white <?php echo e(strpos($currentUri, '/user') !== false ? 'active' : ''); ?>">
